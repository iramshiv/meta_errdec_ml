...
def dmv_view(df1, xxx, db_filename, li):
    template = """"
    ...
    text_file = open(f"./view_error/{db_filename}_view_dmv.html", "w", encoding="utf-8")
    text_file.write(html)
    text_file.close()
    pa = f"file:///C:/Users/Sethu/PycharmProjects/errorDetection_Metadata/view_error/{db_filename}_view_dmv.html"
